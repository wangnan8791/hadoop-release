...
public class OptionsParser {
  ...
  public static DistCpOptions parse(String args[]) throws IllegalArgumentException {
    ...
    if (command.hasOption(DistCpOptionSwitch.TEMP_PATH.getSwitch())){
    	String tempPath = getVal(command, DistCpOptionSwitch.TEMP_PATH.getSwitch());
        if (tempPath != null && !tempPath.isEmpty()) {
          option.setTempWorkPath(new Path(tempPath));
        }
    }
