...
public class DistCpOptions {
  ...
  public DistCpOptions(DistCpOptions that) {
    if (this != that && that != null) {
      ...
      this.tempWorkPath = that.getTempWorkPath();
  ...
  public void setTempWorkPath(Path tempWorkPath) {
	    this.tempWorkPath = tempWorkPath;
  }
