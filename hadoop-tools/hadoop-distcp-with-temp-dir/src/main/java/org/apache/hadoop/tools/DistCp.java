...
import org.apache.hadoop.tools.mapred.CopyWithTempDirMapper;
...
public class DistCp extends Configured implements Tool {
  ...
  private Job createJob() throws IOException {
    ...
    job.setJarByClass(CopyWithTempDirMapper.class);
    configureOutputFormat(job);

    job.setMapperClass(CopyWithTempDirMapper.class);
  ...
  private void configureOutputFormat(Job job) throws IOException {
    ...
    if (inputOptions.getTempWorkPath() != null) {
        CopyOutputFormat.setTempDirectory(job, inputOptions.getTempWorkPath());
    }
